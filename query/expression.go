...
func validateExpressionCondition(condition Condition) error {
	...
	switch field.kind {
	case FieldInteger, FieldString, FieldBoolean, FieldDateTime, FieldDate, FieldTime, FieldDuration:
	default:
	...
	case conditionRHSField:
		...
		if field.kind != condition.rhs.field.kind ||
			(field.kind != FieldInteger && field.kind != FieldString && field.kind != FieldDateTime && field.kind != FieldDate && (field.kind != FieldTime && field.kind != FieldDuration)) {
...
func expressionOrderedValueMatchesField(value ValueKind, field FieldKind) bool {
	return value == ValueDate && field == FieldDate || value == ValueTime && field == FieldTime || value == ValueDuration && field == FieldDuration || value == ValueDateTime && field == FieldDateTime || value == ValueInteger && field == FieldInteger || value == ValueString && field == FieldString
}

func expressionValueMatchesField(value ValueKind, field FieldKind) bool {
	return value == ValueDate && field == FieldDate || value == ValueTime && field == FieldTime || value == ValueDuration && field == FieldDuration || value == ValueDateTime && field == FieldDateTime || value == ValueInteger && field == FieldInteger ||
