...
func supportedProjectRelationQueryTerminal(field ir.Field) bool {
	...
	return field.Kind == ir.FieldAuto || field.Kind == ir.FieldInteger || field.Kind == ir.FieldChar || field.Kind == ir.FieldText || field.Kind == ir.FieldDateTime || field.Kind == ir.FieldDate || field.Kind == ir.FieldTime || field.Kind == ir.FieldBoolean
}
