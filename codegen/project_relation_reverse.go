...
func renderProjectRelationReverseTypes(output *bytes.Buffer, owner projectRelationReverseOwner) {
	...
	for _, relation := range owner.relations {
		...
		for _, terminal := range relation.terminals {
			...
			if terminal.field.Kind == ir.FieldDateTime || terminal.field.Kind == ir.FieldDate || (terminal.field.Kind == ir.FieldTime || terminal.field.Kind == ir.FieldDuration || terminal.field.Kind == ir.FieldFloat) {
