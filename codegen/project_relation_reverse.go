...
const ProjectRelationReverseGeneratorVersion = "godj-codegen-rel-reverse-project-v4"
...
func generateProjectRelationReverse(packageName string, plan *relationProjectPlan) ([]byte, error) {
	...
	if len(queryModels) > 0 || len(collections) > 0 {
