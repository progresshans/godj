...
func runStorage(t *testing.T, open func(context.Context) (jsonBackend, error)) {
	...
	for _, input := range []orm.LookupInput{{Key: "payload", Value: nil}, {Key: "payload", Value: "null"}, {Key: "payload", Value: map[string]any{"a": 1}}, {Key: "payload", Value: jsonvalue.Value{}}, {Key: "payload__gt", Value: sample}, {Key: "payload__icontains", Value: "a"}} {
