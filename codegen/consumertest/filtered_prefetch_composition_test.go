...
func TestGeneratedFilteredPrefetchComposition(t *testing.T) {
	...
	required := []string{"TestFilteredPrefetchComposition/sqlite", "TestFilteredPrefetchComposition/sqlite/eager_and_children", "TestFilteredPrefetchComposition/sqlite/failure_retry", "TestFilteredPrefetchComposition/sqlite/session"}
