...
func safeExistingAddField(field ir.Field) bool {
	...
	return field.Nullable && (field.Kind == ir.FieldChar || field.Kind == ir.FieldText || field.Kind == ir.FieldDateTime || field.Kind == ir.FieldInteger || field.Kind == ir.FieldBoolean)
}
