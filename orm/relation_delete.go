...
func relationDeleteTargetKey(model ir.Model) (ir.Field, bool) {
	...
	for _, field := range model.Fields {
		...
		case ir.FieldChar, ir.FieldText, ir.FieldBoolean, ir.FieldInteger, ir.FieldDateTime, ir.FieldDate, ir.FieldTime, ir.FieldDuration, ir.FieldFloat, ir.FieldDecimal:
			if field.PrimaryKey {
				return ir.Field{}, false
			}
		default:
