...
func supportedRelatedTerminal(field ir.Field, reverse bool) bool {
	...
	switch field.Kind {
	case ir.FieldAuto, ir.FieldInteger, ir.FieldChar, ir.FieldText, ir.FieldDateTime, ir.FieldDate, ir.FieldTime, ir.FieldDuration, ir.FieldFloat, ir.FieldDecimal, ir.FieldUUID, ir.FieldBoolean:
		return true
	default:
		return false
	}
