...
const GoDjProjectRelationFacadeInputSHA256 = "ae29230af08dfc2b80b82550729ca95511cd742fb47fbabd50f097ddbc916eb0"
...
func (_query AuthorsAuthorQuery) Fresh() AuthorsAuthorQuery {
...
func (_query AuthorsAuthorQuery) First(_ctx context.Context) (*AuthorsAuthor, bool, error) {
	...
	_value, _found, _err := orm.MaterializeFirst(_ctx, _query.query, _query.state.models.AuthorsAuthor)
	if _err != nil || !_found {
...
func (_query AuthorsAuthorQuery) All(_ctx context.Context) ([]*AuthorsAuthor, error) {
	...
	_values, _err := orm.Materialize(_ctx, _query.query, _query.state.models.AuthorsAuthor)
	if _err != nil {
		return nil, _err
	}
	_results := make([]*AuthorsAuthor, len(_values))
	for _index := range _values {
		_wrapped, _err := _query.state.materializeAuthorsAuthor(_ctx, _values[_index])
		if _err != nil {
			return nil, _err
		}
...
func (AuthorsAuthor) MarshalJSON() ([]byte, error) {
	return nil, relationFacadeQueryInvalid("direct JSON marshal of generated project model wrapper is unsupported")
}

func (*AuthorsAuthor) UnmarshalJSON([]byte) error {
	return relationFacadeQueryInvalid("direct JSON unmarshal of generated project model wrapper is unsupported")
}

func (_model *AuthorsAuthor) relationFacadeCurrentPrimaryKey() (int64, bool, error) {
	_value, _present := (authors.AuthorDescriptor{}).PrimaryKey(_model.authorsAuthorModel)
...
func (_model *AuthorsAuthor) Unwrap() (authors.Author, error) {
	...
	return (authors.AuthorDescriptor{}).CloneModel(_model.authorsAuthorModel), nil
}
...
func (_model *AuthorsAuthor) Save(_ctx context.Context) error {
	...
	if _err := authors.AuthorObjects.Save(_ctx, _model.state.backend, &_model.authorsAuthorModel); _err != nil {
		return _err
	}
...
func (_state *relationFacadeState) materializeAuthorsAuthor(_ctx context.Context, _value *orm.RelatedSelected[authors.Author]) (*AuthorsAuthor, error) {
	...
	_wrapped, _err := _state.wrapAuthorsAuthor(_raw, false)
	if _err != nil {
		return nil, _err
	}
...
func newBlogPostQuery(_state *relationFacadeState, _query orm.QuerySet[blog.Post]) BlogPostQuery {
	...
	_result.Related = BlogPostRelationSelectors{
		Author:   relationFacadeSelection[blog.Post, authors.Author]{state: _state},
		Reviewer: relationFacadeSelection[blog.Post, authors.Author]{state: _state},
	}
	if _state != nil {
...
func (_query BlogPostQuery) Fresh() BlogPostQuery {
	_query.query = _query.query.Fresh()
	return _query
}
...
func (_query BlogPostQuery) First(_ctx context.Context) (*BlogPost, bool, error) {
	...
	_value, _found, _err := orm.MaterializeFirst(_ctx, _query.query, _query.state.models.BlogPost)
	if _err != nil || !_found {
		return nil, _found, _err
	}
...
func (_query BlogPostQuery) All(_ctx context.Context) ([]*BlogPost, error) {
	...
	_values, _err := orm.Materialize(_ctx, _query.query, _query.state.models.BlogPost)
	if _err != nil {
		return nil, _err
	}
	_results := make([]*BlogPost, len(_values))
	for _index := range _values {
		_wrapped, _err := _query.state.materializeBlogPost(_ctx, _values[_index])
		if _err != nil {
			return nil, _err
		}
		_results[_index] = _wrapped
...
type BlogPost struct {
	...
	reviewerCache             *orm.RelationCache[AuthorsAuthor]
	reviewerScalarSnapshot    int64
	reviewerScalarPresent     bool
	_self                     *BlogPost
}
...
func (_state *relationFacadeState) wrapBlogPostObject(_object *BlogPostObject) (*BlogPost, error) {
	...
	_result.reviewerCache = orm.NewRelationCache[AuthorsAuthor]()
	_result.reviewerScalarPresent = _model.ReviewerID != nil
...
func (BlogPost) MarshalJSON() ([]byte, error) {
	return nil, relationFacadeQueryInvalid("direct JSON marshal of generated project model wrapper is unsupported")
}

func (*BlogPost) UnmarshalJSON([]byte) error {
	return relationFacadeQueryInvalid("direct JSON unmarshal of generated project model wrapper is unsupported")
}

func (_model *BlogPost) relationFacadeCurrentPrimaryKey() (int64, bool, error) {
	_value, _present := (blog.PostDescriptor{}).PrimaryKey(_model.blogPostModel)
	_key, _ok := _value.Integer()
	if !_ok {
		return 0, false, relationFacadeQueryInvalid("generated model descriptor returned a non-integer primary key")
	}
...
func (_model *BlogPost) relationFacadeRefreshSnapshots() error {
	...
	_model.primaryKeySnapshot = _key
	_model.primaryKeySnapshotPresent = _present
	_model.authorScalarSnapshot = _model.blogPostModel.AuthorID
	_model.reviewerScalarPresent = _model.blogPostModel.ReviewerID != nil
	_model.reviewerScalarSnapshot = 0
	if _model.reviewerScalarPresent {
		_model.reviewerScalarSnapshot = *_model.blogPostModel.ReviewerID
	}
	return nil
}
...
func (_model *BlogPost) Unwrap() (blog.Post, error) {
	...
	return (blog.PostDescriptor{}).CloneModel(_model.blogPostModel), nil
}
...
func (_model *BlogPost) Save(_ctx context.Context) error {
	...
	if _err := blog.PostObjects.Save(_ctx, _model.state.backend, &_model.blogPostModel); _err != nil {
		return _err
	}
	return _model.relationFacadeRefreshSnapshots()
}
...
func (_model *BlogPost) relationFacadeDerived(_value blog.Post) (*BlogPost, error) {
	...
	_result.reviewerScalarSnapshot = _model.reviewerScalarSnapshot
	_result.reviewerScalarPresent = _model.reviewerScalarPresent
...
func (_model *BlogPost) relationFacadeReconcile() error {
	if _err := _model.validate(); _err != nil {
		return _err
	}
	if _, _, _err := _model.relationFacadePrimaryKey(); _err != nil {
	...
	if _, _, _, _err := _model.authorCache.Snapshot(); _err != nil {
		return _err
	}
	if _, _, _, _err := _model.reviewerCache.Snapshot(); _err != nil {
		return _err
	}
	_authorCurrentKey := _model.blogPostModel.AuthorID
	_authorChanged := _authorCurrentKey != _model.authorScalarSnapshot
	_authorCurrentPresent := _model.authorScalarPresent || _authorChanged
	_reviewerCurrentPresent := _model.blogPostModel.ReviewerID != nil
	var _reviewerCurrentKey int64
	if _reviewerCurrentPresent {
	...
	_nextModel := (blog.PostDescriptor{}).CloneWriteModel(_model.blogPostModel)
	_nextObject, _err := _model.state.objects.BlogPost.From(_model.state.backend, _nextModel)
	if _err != nil {
		return _err
	}
	_nextAuthorCache := _model.authorCache
	if _authorChanged {
		_nextAuthorCache = orm.NewRelationCache[AuthorsAuthor]()
	}
	_nextReviewerCache := _model.reviewerCache
	if _reviewerChanged {
		_nextReviewerCache = orm.NewRelationCache[AuthorsAuthor]()
		if !_reviewerCurrentPresent {
			if _err := _nextReviewerCache.Store(orm.RelationAssignedAbsent, nil, false); _err != nil {
				return _err
			}
		}
	}
	_model.blogPostModel = _nextModel
	_model.object = _nextObject
	if _authorChanged {
		_model.authorCache = _nextAuthorCache
		_model.authorScalarSnapshot = _authorCurrentKey
		_model.authorScalarPresent = _authorCurrentPresent
	}
	if _reviewerChanged {
		_model.reviewerCache = _nextReviewerCache
		_model.reviewerScalarSnapshot = _reviewerCurrentKey
		_model.reviewerScalarPresent = _reviewerCurrentPresent
	}
	return nil
}
...
func (_model *BlogPost) relationFacadePrepareSave() error {
	...
	if _authorState == orm.RelationAssignedPresent {
	...
	if _reviewerState == orm.RelationAssignedPresent {
	...
	if _authorState == orm.RelationAssignedPresent && !_authorPresent {
	...
	_authorReconcile := _authorState == orm.RelationAssignedPresent && _authorPending
	_reviewerReconcile := _reviewerState == orm.RelationAssignedPresent && _reviewerPending
	_nextModel := (blog.PostDescriptor{}).CloneWriteModel(_model.blogPostModel)
	_rebuild := false
	if _authorReconcile {
	...
	if _rebuild {
		...
		if _authorReconcile {
			...
			if _err := _nextAuthorCache.Store(orm.RelationAssignedPresent, _authorTarget, false); _err != nil {
				return _err
			}
		}
		_nextReviewerCache := _model.reviewerCache
		if _reviewerReconcile {
			...
			if _err := _nextReviewerCache.Store(orm.RelationAssignedPresent, _reviewerTarget, false); _err != nil {
				return _err
			}
		}
		_model.blogPostModel = _nextModel
		...
		if _authorReconcile {
			_model.authorCache = _nextAuthorCache
			_model.authorScalarSnapshot = _authorKey
			_model.authorScalarPresent = true
		}
		if _reviewerReconcile {
			_model.reviewerCache = _nextReviewerCache
			_model.reviewerScalarSnapshot = _reviewerKey
			_model.reviewerScalarPresent = true
		}
	}
	return nil
}
...
func (_model *BlogPost) WithAuthor(_target *AuthorsAuthor) (*BlogPost, error) {
	...
	_value := (blog.PostDescriptor{}).CloneWriteModel(_model.blogPostModel)
	if _present {
	...
	_result.authorScalarSnapshot = _key
	_result.authorScalarPresent = _present
	if _err := _result.authorCache.Store(orm.RelationAssignedPresent, _target, !_present); _err != nil {
		return nil, _err
	}
	return _result, nil
}
...
func (_model *BlogPost) WithAuthorID(_key int64) (*BlogPost, error) {
	...
	_result.authorScalarSnapshot = int64(_key)
	_result.authorScalarPresent = true
	if !_same {
		if _err := _result.authorCache.Store(orm.RelationUnassigned, nil, false); _err != nil {
			return nil, _err
		}
	}
	return _result, nil
...
func (_model *BlogPost) WithReviewer(_target *AuthorsAuthor) (*BlogPost, error) {
	...
	_result.reviewerScalarSnapshot = _key
	_result.reviewerScalarPresent = _present
	if _err := _result.reviewerCache.Store(orm.RelationAssignedPresent, _target, !_present); _err != nil {
		return nil, _err
	}
	return _result, nil
}
...
func (_model *BlogPost) WithReviewerID(_key int64) (*BlogPost, error) {
	...
	_result.reviewerScalarSnapshot = int64(_key)
	_result.reviewerScalarPresent = true
	if !_same {
		if _err := _result.reviewerCache.Store(orm.RelationUnassigned, nil, false); _err != nil {
			return nil, _err
		}
	}
	return _result, nil
...
func (_model *BlogPost) ClearReviewer() (*BlogPost, error) {
	...
	_result.reviewerScalarSnapshot = 0
	_result.reviewerScalarPresent = false
	if _err := _result.reviewerCache.Store(orm.RelationAssignedAbsent, nil, false); _err != nil {
		return nil, _err
	}
	return _result, nil
}
...
func (_model *BlogPost) Author(_ctx context.Context) (*AuthorsAuthor, error) {
	...
	if _err := _model.authorCache.Store(orm.RelationAssignedPresent, _wrapped, false); _err != nil {
		return nil, _err
	}
	return _wrapped, nil
}
...
func (_model *BlogPost) Reviewer(_ctx context.Context) (*AuthorsAuthor, bool, error) {
	...
	if _err := _model.reviewerCache.Store(orm.RelationAssignedPresent, _wrapped, false); _err != nil {
		return nil, false, _err
	}
	return _wrapped, true, nil
}
...
type BlogPostRelationSelectors struct {
	Author   relationFacadeSelection[blog.Post, authors.Author]
	Reviewer relationFacadeSelection[blog.Post, authors.Author]
}
...
func (_query BlogPostQuery) SelectRelated(_selectors ...BlogPostRelationSelector) BlogPostEagerQuery {
	...
	return _query.state.newBlogPostEagerQuery(_query.query, _inputs)
}
func (_query BlogPostQuery) SelectRelatedPaths(_paths ...string) (BlogPostEagerQuery, error) {
	if _err := _query.validate(); _err != nil {
	...
	_result := _query.state.newBlogPostEagerQuery(_query.query, _inputs)
	if _result.configurationErr != nil {
		return BlogPostEagerQuery{}, _result.configurationErr
	}
	return _result, nil
}
...
func (_query BlogPostEagerQuery) Filter(_values ...orm.Predicate[blog.Post]) BlogPostEagerQuery {
	...
	return _query.state.newBlogPostEagerQuery(_query.source.Filter(_values...), _query.selections)
}
func (_query BlogPostEagerQuery) OrderBy(_values ...orm.Ordering[blog.Post]) BlogPostEagerQuery {
	if _err := _query.validate(); _err != nil {
		_query.configurationErr = _err
		return _query
	}
	return _query.state.newBlogPostEagerQuery(_query.source.OrderBy(_values...), _query.selections)
}
func (_query BlogPostEagerQuery) Distinct() BlogPostEagerQuery {
	...
	return _query.state.newBlogPostEagerQuery(_query.source.Distinct(), _query.selections)
}
func (_query BlogPostEagerQuery) Fresh() BlogPostEagerQuery {
	...
	return _query.state.newBlogPostEagerQuery(_query.source.Fresh(), _query.selections)
}
func (_query BlogPostEagerQuery) Limit(_value int) (BlogPostEagerQuery, error) {
	if _err := _query.validate(); _err != nil {
		return BlogPostEagerQuery{}, _err
	}
...
func (_query BlogPostEagerQuery) Offset(_value int) (BlogPostEagerQuery, error) {
	if _err := _query.validate(); _err != nil {
		return BlogPostEagerQuery{}, _err
	}
...
func (_query BlogPostEagerQuery) All(_ctx context.Context) ([]*BlogPost, error) {
	...
	for _index, _object := range _objects {
		_results[_index], _err = _query.state.wrapSelectedBlogPostObject(_ctx, _object)
		if _err != nil {
			return nil, _err
		}
	}
...
func (_state *relationFacadeState) wrapSelectedBlogPostObject(_ctx context.Context, _object *BlogPostObject) (*BlogPost, error) {
	_wrapped, _err := _state.wrapBlogPostObject(_object)
	if _err != nil {
		return nil, _err
	}
	...
	if _has, _err := _object._selectedGraph.HasSelection("reviewer"); _err != nil {
		return nil, _err
	} else if _has {
...
func (_state *relationFacadeState) materializeBlogPost(_ctx context.Context, _value *orm.RelatedSelected[blog.Post]) (*BlogPost, error) {
	_object, _err := _state.objects.BlogPost.FromSelected(_value)
	if _err != nil {
		return nil, _err
	}
