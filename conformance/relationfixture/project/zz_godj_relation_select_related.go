...
func (_query BlogPostAuthorSelectRelatedQuery) Count(_ctx context.Context) (int64, error) {
...
func (_query BlogPostReviewerSelectRelatedQuery) Count(_ctx context.Context) (int64, error) {
	return _query.query.WithConfigurationError(_query.configurationErr).Count(_ctx)
}
...
func (_query BlogPostDynamicSelectRelatedQuery) Count(_ctx context.Context) (int64, error) {
	if _err := _query.validate(); _err != nil {
		return (orm.ForwardSelectQuery[blog.Post, blog.Post]{}).WithConfigurationError(_err).Count(_ctx)
	}
