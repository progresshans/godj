// Package fixture owns the REL-009/010/011 declaration schemas used to verify
// the checked-in generated select-related product. Runtime observation imports
...
func AuthorsSchema() (ir.Schema, error) {
	...
	if err != nil {
		return ir.Schema{}, fmt.Errorf("build authors select-related schema: %w", err)
	}
	return result, nil
}
...
func BlogSchema() (ir.Schema, error) {
	...
	if err != nil {
		return ir.Schema{}, fmt.Errorf("build blog select-related schema: %w", err)
	}
	return result, nil
}
