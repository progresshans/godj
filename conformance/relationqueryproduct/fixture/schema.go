// Package fixture owns the REL-004 declaration schemas used to verify the
// checked-in generated relation-query product. Runtime observation imports
...
func AuthorsSchema() (ir.Schema, error) {
	...
	if err != nil {
		return ir.Schema{}, fmt.Errorf("build authors relation-query schema: %w", err)
	}
	return result, nil
}
...
func BlogSchema() (ir.Schema, error) {
	...
	if err != nil {
		return ir.Schema{}, fmt.Errorf("build blog relation-query schema: %w", err)
	}
	return result, nil
}
