...
func TestReferenceOracleChecksumCatalogMatchesCurrentArtifacts(t *testing.T) {
	...
	if string(contents) != previous+definitionSource+projectCheck+migrationCommand+migrationWriter+migrationStatus+relation+migrationRelation+queryExpression+gdj0043+systemState {
