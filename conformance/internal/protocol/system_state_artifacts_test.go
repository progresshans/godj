...
func TestSystemStateArtifactBytesAreLocked(t *testing.T) {
	...
	wanted := map[string]artifactLock{
		...
		"conformance/systemstate/attestations/postgresql-17.10-two-process-v1.json": {1134, "5b2055445b787acdd018771a4f8c1395b19e96ae7ce3efce8d9efe85b02c004e"},
		"conformance/systemstate/attestations/SHA256SUMS":                           {103, "41ca18d7baa6e9d60e146db728eeaa811f65fd48077943cf75d567627a9c8615"},
	}
...
func TestCurrentTwentyTwoReferenceSetsHave249ContractsAndReject462OrderedCrossBindings(t *testing.T) {
	...
	if len(sets) != 22 || total != 249 || len(ids) != 249 || len(scenarios) != 249 || passing != 218 || deviations != 19 || locked != 12 {
