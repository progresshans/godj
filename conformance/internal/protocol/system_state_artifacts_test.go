...
func TestSystemStateArtifactBytesAreLocked(t *testing.T) {
	...
	wanted := map[string]artifactLock{
		...
		"conformance/systemstate/attestations/postgresql-17.10-two-process-v1.json": {1134, "8d8bdd0da8a78edb39a7d409a06825892f7585cf3bb159573d6ea3ef6f0d94c6"},
		"conformance/systemstate/attestations/SHA256SUMS":                           {103, "800c46bc6e453dfb8f45e25144fe917e0d7d41f0db26c19e64b2ffff44b5600b"},
	}
...
func TestCurrentTwentyFourReferenceSetsHave273ContractsAndReject552OrderedCrossBindings(t *testing.T) {
	...
	if len(sets) != 24 || total != 273 || len(ids) != 273 || len(scenarios) != 273 || passing != 237 || deviations != 24 || locked != 12 {
