...
func TestCheckedInOracleChecksumsMatchArtifacts(t *testing.T) {
	...
	wantedPaths := []string{"migration-execution-oracle.json", "migration-lifecycle-oracle.json", "migration-planning-oracle.json", "migration-restart-oracle.json", "migration-state-reconstruction-oracle.json", "oracle.json", "query-cache-oracle.json", "query-breadth-oracle.json", "save-lifecycle-oracle.json", "write-migration-oracle.json", "migration-definition-source-oracle.json", "migration-project-check-oracle.json", "relation-oracle.json", "migration-relation-oracle.json", "query-expression-oracle.json", "template-form-oracle.json", "auth-session-oracle.json", "article-admin-oracle.json"}
