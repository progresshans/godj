...
IR vNext는 field-union relation arm 방향을 채택했습니다. Active GDJ-0024/Proposed ADR-0024는 그중
...
거부합니다. Query selector/loader/cache/write/delete/DDL/migration codec API는 후속이며 이 Proposed shape가
아직 구현됐다는 뜻이 아닙니다.
