...
| [0048](0048-database-coordinated-system-state-and-shared-csrf-key-ring.md) | Proposed | Database-coordinated cooperative multi-runtime system state와 shared CSRF key ring |
