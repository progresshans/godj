...
| [0034](0034-relation-capable-migration-format-state-and-sqlite-foreign-key-ddl.md) | Proposed | Legacy ABI를 보존하는 relation definition/state profile과 bounded SQLite ForeignKey lifecycle candidate |
