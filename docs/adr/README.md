...
| [0047](0047-explicit-single-runtime-system-state.md) | Proposed | Current migration 기반 single-runtime auth/session/audit를 source-local 구현·게시; required PostgreSQL/hosted acceptance pending |
