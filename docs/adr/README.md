...
| [0050](0050-canonical-embedded-application-model-facade.md) | Proposed | Embedded raw scalar/user method와 project-owned relation state를 결합하는 current application model facade |
