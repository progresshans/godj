...
| [0057](0057-sqlite-retained-connection-terminal-quarantine.md) | Proposed | SQLite retained connection hard bound, terminal recovery-required와 explicit Close ownership |
