...
| [0053](0053-project-linked-read-only-migration-status.md) | Proposed | Project-linked read-only applied-history snapshot과 deterministic `showmigrations` list 경계 |
