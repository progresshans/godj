...
| [0025](0025-forward-foreign-key-predicate-and-sqlite-inner-join.md) | Proposed | Required forward FK exact predicate, shared relation path와 SQLite reusable INNER JOIN |
