...
| [0052](0052-project-linked-deterministic-makemigrations.md) | Proposed | Additive-only schema autodetection, deterministic current definition과 recoverable global `makemigrations` publication 경계 |
