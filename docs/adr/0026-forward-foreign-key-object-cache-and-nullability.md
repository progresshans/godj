...
ADR-0035는 이 ADR의 forward object/cache, nullable access와 `isnull` observable/runtime 의미를 유지합니다.
다만 본문의 IR v2/v3 명칭, query/object companion prerequisite, 기존 generated bytes 보존과 additive publication
