...
ManyToMany direct/nested/filtered prefetch와 단일 관계 prefetch·root eager의 직접 조합을 구현했다. Owner별 slice·custom single target query, Ticket 소비자와 GDJ-0099 Hosted 전체 통합은 남아 있다.
