...
통합 model facade·외부 transaction composition·일반 ManyToMany 관계 조건/prefetch·Ticket 소비자와 GDJ-0099 Hosted 전체 통합은 남아 있다.
