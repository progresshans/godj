...
ManyToMany direct prefetch는 구현했으며 중첩/filtered child prefetch·eager와의 tree 통합, Ticket 소비자와 GDJ-0099 Hosted 전체 통합은 남아 있다.
