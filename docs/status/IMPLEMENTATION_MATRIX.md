...
| 관계 | AutoField-target FK, 자기·상호 참조 선언/생성, lazy/forward/reverse, nullable/required forward 대상 exact와 AND/OR/NOT, prefetch/eager All·First·Count, assignment/cache, PROTECT/SET_NULL | eager First는 명시적 정렬 필요; typed/dynamic의 nullable 대상 scalar 자체·reverse OR/NOT·임의 깊이/다중 관계 탐색·일반 순환 관계 동작·ManyToMany/OneToOne 미지원 | [관계 소유권](../CONCURRENCY.md#관계-객체) |
