...
ManyToMany direct/nested/filtered prefetch는 구현했으며 eager와의 tree 통합·owner별 slice, Ticket 소비자와 GDJ-0099 Hosted 전체 통합은 남아 있다.
