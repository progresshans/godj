...
|---|---|---|---|---|---|---|
| Compatibility profile | META-001 | Accepted exact profile | Implemented | [Pass EVID-005](TEST_EVIDENCE.md#evid-20260808-005--gdj-0006-save-lifecycle-product-slice) | M1/M2/Save oracle profile bound | Django 6.1 / SQLite 3.50.4 reference |
| Contract/oracle harness | META-002 | Accepted protocol v2 | Django/GoDj 3 set adapters implemented | [Pass EVID-005](TEST_EVIDENCE.md#evid-20260808-005--gdj-0006-save-lifecycle-product-slice) | 11 + 11 + 12, 총 34 `passing` | Django exact reference + Go SQLite 3.53.3 |
...
| QuerySet cache semantics | Q-007 / QRY-011..QRY-020 candidate | Active GDJ-0007 contract work | M1 intentionally uncached; cache product not implemented | Reference probe in progress; product test not run | Not claimed | — |
