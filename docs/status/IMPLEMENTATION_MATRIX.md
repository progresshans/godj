...
Owner별 slice는 Query AST·양 DB window compiler까지 연결했다. 별도 snapshot의 runtime/generated API·owner batch 통합,
custom single target query, Ticket 소비자와 GDJ-0099 Hosted 전체 통합은 남아 있다.
