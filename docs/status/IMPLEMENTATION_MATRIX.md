...
| 관계 | AutoField-target FK, 자기·상호 참조 선언/생성, lazy/forward/reverse, prefetch/eager All·First·Count, assignment/cache, PROTECT/SET_NULL | eager First는 명시적 정렬 필요; nullable target-field lookup·임의 깊이/다중 관계 탐색·일반 순환 관계 동작·ManyToMany/OneToOne 미지원 | [관계 소유권](../CONCURRENCY.md#관계-객체) |
