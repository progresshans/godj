...
|---|---|---|---|---|---|---|
| Compatibility profile | META-001 | Accepted exact profile | Implemented | [Pass EVID-006](TEST_EVIDENCE.md#evid-20260808-006--gdj-0007-queryset-evaluation-and-cache-compatibility-contracts) | Four oracle sets bound to one exact profile | Django 6.1 / SQLite 3.50.4 reference |
| Contract/oracle harness | META-002 | Accepted protocol v2 | Django 4-set runner; GoDj existing 3-set adapters implemented | [Pass EVID-006](TEST_EVIDENCE.md#evid-20260808-006--gdj-0007-queryset-evaluation-and-cache-compatibility-contracts) | 34 `passing` + QuerySet cache 11 `oracle_locked` | Django exact reference + Go SQLite 3.53.3 |
...
| Deterministic codegen | GEN-M1-001 | ADR-0002/0006/0009/0011 Accepted | Read model + create/patch/write descriptor + Save/key helpers, hash/golden/check/last-good | [Pass EVID-005](TEST_EVIDENCE.md#evid-20260808-005--gdj-0006-save-lifecycle-product-slice) | SCH/MOD generated paths `passing` | external positive/negative compile |
...
| Generated model/FieldSet | GEN-M1-001 | ADR-0007/0009/0011 Accepted for verified subset | Article/FieldSet/descriptor/Manager/create/patch/Save option binding implemented | [Pass EVID-005](TEST_EVIDENCE.md#evid-20260808-005--gdj-0006-save-lifecycle-product-slice) | QRY/SCH/MOD subset `passing` | SQLite 3.53.3 |
...
| QuerySet evaluation/cache reference | QRY-011..QRY-021 | Accepted GDJ-0007 contracts | Django runner/oracle + explicit not-implemented fixture | [Pass EVID-006](TEST_EVIDENCE.md#evid-20260808-006--gdj-0007-queryset-evaluation-and-cache-compatibility-contracts) | 11 `oracle_locked`; static fixture는 expected 11 mismatch | Django 6.1 / SQLite 3.50.4 |
| QuerySet cache/terminal product | Q-007, Q-011 / QRY-011..QRY-021 | [ADR-0012](../adr/0012-queryset-evaluation-cache-ownership.md) Accepted; active GDJ-0008 | M1 QuerySet intentionally uncached; product not implemented | External spike pass; product not run | Not claimed | — |
