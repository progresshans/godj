...
자동 intermediary의 storage migration·raw CreateModel의 columnless 선언·조회·manager·컬렉션 소비자는 남았고 해당 경계는 명시적으로 거부한다.
