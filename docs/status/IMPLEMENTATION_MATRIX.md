...
|---|---|---|---|---|---|---|
| Compatibility profile | META-001 | Accepted exact profile | Implemented | [Pass EVID-007](TEST_EVIDENCE.md#evid-20260808-007--gdj-0008-queryset-evaluation-and-cache-product-slice) | Four oracle sets bound to one exact profile | Django 6.1 / SQLite 3.50.4 reference |
| Contract/oracle harness | META-002 | Accepted protocol v2 | Django/GoDj 4-set adapters implemented | [Pass EVID-007](TEST_EVIDENCE.md#evid-20260808-007--gdj-0008-queryset-evaluation-and-cache-product-slice) | 45 `passing`; query static fixture remains expected 11 mismatch | Django exact reference + Go SQLite 3.53.3 |
...
| Migration planning reference | MIG-005..MIG-016 candidates | Active GDJ-0009 contract discovery | Not started; product source excluded | Not run | Not locked | Django 6.1 / SQLite 3.50.4 reference |
