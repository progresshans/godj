...
| Migration | strict current definition, historical replay, immutable planner, revision fence, durable prefix, choices-only AlterField와 bounded reverse; historical self/cyclic graph·여러 FK Add/Remove·transitive target | 일반 새 cyclic 모델의 자동 migration 분할과 넓은 schema 변경은 후속 | [migrations](../../migrations/) |
