...
|---|---|---|---|
| Schema/IR | Auto·signed int64 Integer(nullable/default)·Char·Text·Date·DateTime·Time·Duration·Float(binary64/nullable/default)·Decimal(exact coefficient/exponent·precision/scale)·UUID(128-bit/nullable/default)·JSON(exact token·SQL/JSON null·nullable/default)·Boolean(nullable/default)·FK, string/int64 choices, column Unique 선언·정규화·생성 metadata, normalized immutable snapshot | UNIQUE 물리 제약은 구현 중; 넓은 field/constraint·custom field 미지원 | [schema](../../schema/), [정수 의미](../adr/0059-signed-integer-field-and-model-growth.md), [Text 의미](../adr/0060-text-field-and-form-widget-semantics.md), [DateTime 의미](../adr/0061-datetime-field-and-canonical-instant-values.md), [Date 의미](../adr/0065-calendar-date-field-and-input-boundaries.md), [Time 의미](../adr/0066-clock-time-field-and-precision-boundaries.md), [Duration 의미](../adr/0067-duration-model-range-and-number-input.md), [Float 의미](../adr/0068-binary64-field-and-finite-json-boundaries.md), [Decimal 의미](../adr/0069-exact-decimal-values-and-storage.md), [UUID 의미](../adr/0070-uuid-model-values-and-storage.md), [JSON 의미](../adr/0071-json-values-and-native-storage-boundaries.md) |
...
| Migration | strict current definition, historical replay, immutable planner, revision fence, durable prefix, choices-only·Decimal precision-only AlterField와 bounded reverse; historical self/cyclic graph·여러 FK Add/Remove·transitive target; self/later/cyclic 자동 계획·선언 순서와 prefix 재개 | Unique의 historical wire/digest·자동 변경 계획은 지원, 양 DB 실제 제약은 미지원으로 거부; required FK 추가는 빈 table에서만 적용; 넓은 schema 변경·backfill은 후속 | [migrations](../../migrations/) |
