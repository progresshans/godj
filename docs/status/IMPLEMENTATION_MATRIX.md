...
|---|---|---|---|---|---|---|
| Compatibility profile | META-001 | Accepted exact profile | Implemented | [Pass EVID-008](TEST_EVIDENCE.md#evid-20260808-008--gdj-0009-migration-planning-compatibility-contracts) | Five oracle sets bound to one exact profile | Django 6.1 / SQLite 3.50.4 reference |
| Contract/oracle harness | META-002 | Accepted protocol v2 | Five-set Django harness; four GoDj product adapters, fifth explicit unsupported baseline | [Pass EVID-008](TEST_EVIDENCE.md#evid-20260808-008--gdj-0009-migration-planning-compatibility-contracts) | 45 `passing`; planning 12 `oracle_locked` + static expected 12 mismatch | Django exact reference + Go SQLite 3.53.3 |
...
| Migration planning reference | MIG-005..MIG-016 | Accepted GDJ-0009 contracts | Django runner/oracle + explicit not-implemented fixture; GoDj product adapter 없음 | [Pass EVID-008](TEST_EVIDENCE.md#evid-20260808-008--gdj-0009-migration-planning-compatibility-contracts) | 12 `oracle_locked`; static ordered 12 mismatch | Django 6.1 / SQLite 3.50.4 reference |
| Migration graph/planner product | MIG-005..MIG-016 / Q-012 | [ADR-0013](../adr/0013-immutable-migration-planner.md) Accepted; GDJ-0010 active | Not started | Not run | Not run; existing product remains 45 `passing` | Backend-neutral zero-I/O target |
