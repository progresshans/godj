...
|---|---|---|---|---|---|---|
| Compatibility profile | META-001 | Accepted exact profile | Implemented | [Pass EVID-004](TEST_EVIDENCE.md#evid-20260808-004--gdj-0005-save-lifecycle-compatibility-contracts) | M1/M2/Save oracle profile bound | Django 6.1 / SQLite 3.50.4 reference |
| Contract/oracle harness | META-002 | Accepted protocol v2 | Django 3 set와 GoDj M1/M2 adapters implemented | [Pass EVID-004](TEST_EVIDENCE.md#evid-20260808-004--gdj-0005-save-lifecycle-compatibility-contracts) | M1/M2 각 11 `passing`; Save 12 `oracle_locked` | Django exact reference + Go SQLite 3.53.3 |
...
| Save lifecycle reference oracle | MOD-008..MOD-019 | Accepted GDJ-0005 contracts | Django runner/oracle + explicit not-implemented fixture | [Pass EVID-004](TEST_EVIDENCE.md#evid-20260808-004--gdj-0005-save-lifecycle-compatibility-contracts) | 12 `oracle_locked`; static actual은 expected 12 mismatch | Django 6.1 / SQLite 3.50.4 |
| Mutable instance Save product | MOD-008..MOD-019 | Active GDJ-0006 design spike | Not started | Not run | Not run; passing 미주장 | SQLite target |
