...
- 검증 보완: [첫 Duration Hosted full](https://github.com/progresshans/godj/actions/runs/35478903468)의 stale scenario digest를 수정했고 새 source의 full을 준비한다.
...
Python 네 버전에서 재검증했다. 수정 source의 full을 실행해 필수 job의 terminal 결과와 실제 source·scope를 확인한다.
