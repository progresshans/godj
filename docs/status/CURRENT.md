...
- 통합 검증 중: [GDJ-0080 Eager/filter JOIN](../../work/0080-eager-filter-join-composition.md), source `7397a73b933eef4d30c5a8fa12c84a79fc7945e9`, [Hosted ORM](https://github.com/progresshans/godj/actions/runs/35414363995)
...
Self-reference의 정방향/역방향 FK metadata 검증 보완 source의 Hosted 완료를 확인해 GDJ-0080을 기록한다.
