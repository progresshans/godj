...
| Q-013 | OneToOne/ManyToMany, arbitrary target/depth/cycle와 relation 일반화 | AutoField-target FK와 현행 query/cache/delete 단면 구현; OneToOne 선언·migration·single reverse/prefetch·직접 조건·facade typed/dynamic 혼합 eager는 GDJ-0096에서 연결, 전체 소비자 미완료 |
