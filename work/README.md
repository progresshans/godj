...
[GDJ-0043](0043-safe-template-validation-session-auth-and-article-admin.md)입니다. 현재 active packet과 ready packet은
각각 0입니다. 다음 활성화 후보는 GDJ-0044 session-authenticated Article JSON API wide vertical packet입니다.
