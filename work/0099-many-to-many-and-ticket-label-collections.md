...
Nested/filtered/eager prefetch의 독립 결과와 cache/query-count 기준을 확보했다. Eager 조합의 관찰은 아직 reference-only다.
...
기존 하위 설정과 공유 node budget을 유지하도록 연결했다. 이어서 eager parent 재사용·직접 tree 조합·owner별 slice window를 연결한다.
