...
고정 Django 6.1/DRF 3.18.0의 [독립 관찰기](../conformance/runners/django/choices_reference.py)를 준비했다.
로컬 fresh SQLite probe에서 다음 의미를 확인했으며 GoDj의 구현·비교 PASS는 아직 아니다.
...
- 현재 GoDj writer는 기존 field metadata 변경을 거부하므로 choices의 이력을 위한 state transition을 함께 구현해야 한다.
