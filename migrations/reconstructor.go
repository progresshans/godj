...
func loadedScanFieldResource(budget *loadedResourceBudget, migration Migration, operationIndex int, kind, path string, field ir.Field) {
	...
	if field.Default != nil {
		...
		loadedConsumeString(budget, migration, operationIndex, kind, path+".default.time", field.Default.Time, true)
	...
	for index, choice := range field.Choices {
		...
		loadedConsumeString(budget, migration, operationIndex, kind, prefix+".value.time", choice.Value.Time, true)
