...
var requiredChecks = [...]string{
	...
	"helpdesk_session_integer_values",
...
func run(ctx context.Context, config input) ([]string, error) {
	...
	flows := []struct {
		...
		{func() error { return checkHelpdeskSession(ctx, config.HelpdeskSession) }, []string{
			"helpdesk_session_relations", "helpdesk_session_create_defaults", "helpdesk_session_integer_values", "helpdesk_session_read_only_denied",
		}},
