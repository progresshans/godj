...
// ValueKind identifies closed serialized values. Non-integer JSON numbers retain
// their exact lexical form; no floating-point conversion occurs at ingress.
...
func (v Value) validValue() bool {
	...
	switch v.kind {
	case ValueNull, ValueBoolean, ValueInteger, ValueList, ValueDateTime, ValueDate, ValueTime, ValueDuration, ValueNumber, ValueFloat, ValueDecimal, ValueUUID, ValueJSON:
