...
func ValueMatchesField(value query.ValueKind, field query.FieldKind) bool {
	return (value == query.ValueDate && field == query.FieldDate) || (value == query.ValueDateTime && field == query.FieldDateTime) || (value == query.ValueInteger && field == query.FieldInteger) ||
